...
// ============================================
export function renderStaffAttendanceReportsTable() {
        ...
        <div class="content-card">
            <div class="items-header">
                ...
                <div class="inv-filter-group">
                        ...
                        <select id="invMonthSelect"></select>
                    </div>
                    ...
                    <form id="itemsForm" onsubmit="submitItemForm(event)" class="form-responsive">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="staffName" required placeholder="Enter staff name">
                            </div>
...
// FORM FUNCTIONS
// ============================================
function openStaffAttendanceForm() {
    editingItemId = null;
    document.getElementById("formTitle").textContent = "Add New Staff Attendance";
...
window.openStaffAttendanceForm = openStaffAttendanceForm;
...
window.initMonthDropdown = initMonthDropdown;
